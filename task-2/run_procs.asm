...
parcurgere1:
    ...
    xor esi, esi
    mov esi, ebx ;; lucrez cu lungimea in esi

    xor edi, edi

    mov word [time_result + edx * 4], 0
    mov word [prio_result + edx * 4], 0
    
    parcurgere2:

    ;; initializez cei 2 vectori pentru fiecare prioritate
    ...
    cmp edx, 5 ;; 5 este val maxima de prioritate
    jl parcurgere1 ;; daca e mai mica, continui actiunea
